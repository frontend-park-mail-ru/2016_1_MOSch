define(function (require) {
	...
	QUnit.test("applicationView работает (other views)", function () {
		...
		QUnit.ok(application._views.menu instanceof Backbone.View);
		QUnit.ok(application._views.register instanceof Backbone.View);
		QUnit.ok(application._views.login instanceof Backbone.View);
		QUnit.ok(application._views.scoreboard instanceof Backbone.View);
		QUnit.ok(application._views.about instanceof Backbone.View);
		QUnit.ok(application._views.game instanceof Backbone.View);
	});
